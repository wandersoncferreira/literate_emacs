...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (react-snippets tide rjsx-mode json-mode elfeed dockerfile-mode fix-word cider clojure-mode pip-requirements git-timemachine mo-git-blame git-blamed keyfreq persistent-scratch restart-emacs yaml-mode flycheck emmet-mode web-mode php-mode org-present move-dup graphviz-dot-mode paredit yasnippet multiple-cursors dpaste emms request typit typing-game perspective hardcore-mode yasnippet-snippets whitespace-cleanup-mode smex restclient projectile prodigy magit jump-char ido-vertical-mode ido-completing-read+ ido-at-point htmlize highlight-escape-sequences flx-ido expand-region exec-path-from-shell elpy elisp-slime-nav diminish clojure-snippets clojure-mode-extra-font-locking clj-refactor browse-kill-ring ace-jump-mode))))
(custom-set-faces
